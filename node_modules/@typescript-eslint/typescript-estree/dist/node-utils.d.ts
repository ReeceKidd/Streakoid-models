...
export declare function getBinaryExpressionType<T extends ts.SyntaxKind>(
    operator: ts.Token<T>,
): AST_NODE_TYPES.AssignmentExpression | AST_NODE_TYPES.LogicalExpression | AST_NODE_TYPES.BinaryExpression;
/**
 ...
 * @returns is Optional
 */
export declare function isOptional(node: { questionToken?: ts.QuestionToken }): boolean;
/**
