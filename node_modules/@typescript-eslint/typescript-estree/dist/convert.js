    ...
    convertNode(node, parent) {
        ...
        switch (node.kind) {
            ...
            case SyntaxKind.PropertyDeclaration: {
                ...
                if (
                    (node.name.kind === SyntaxKind.Identifier || node.name.kind === SyntaxKind.ComputedPropertyName) &&
                    node.questionToken
                ) {
            ...
            case SyntaxKind.MethodDeclaration: {
                ...
                if (result.key.type === ts_estree_1.AST_NODE_TYPES.Identifier && node.questionToken) {
            ...
            case SyntaxKind.Constructor: {
                ...
                const constructorToken =
                    (lastModifier && node_utils_1.findNextToken(lastModifier, node, this.ast)) || node.getFirstToken();
                    ...
                    if (node.dotDotDotToken) {
                        result = this.createNode(node, {
                            ...
                            argument: this.convertChild(
                                (_a = node.propertyName) !== null && _a !== void 0 ? _a : node.name,
                            ),
                        });
                    } else {
                        result = this.createNode(node, {
            ...
            case SyntaxKind.Parameter: {
                ...
                if (node.modifiers) {
                    return this.createNode(node, {
                        ...
                        accessibility:
                            (_c = node_utils_1.getTSNodeAccessibility(node)) !== null && _c !== void 0 ? _c : undefined,
                        readonly: node_utils_1.hasModifier(SyntaxKind.ReadonlyKeyword, node) || undefined,
                        ...
                        switch (node.importClause.namedBindings.kind) {
                            ...
                            case SyntaxKind.NamedImports:
                                result.specifiers = result.specifiers.concat(
                                    node.importClause.namedBindings.elements.map(el => this.convertChild(el)),
                                );
                                break;
                        }
                    }
            ...
            case SyntaxKind.ExportDeclaration:
                if (
                    ((_f = node.exportClause) === null || _f === void 0 ? void 0 : _f.kind) === SyntaxKind.NamedExports
                ) {
                    return this.createNode(node, {
                        type: ts_estree_1.AST_NODE_TYPES.ExportNamedDeclaration,
                        source: this.convertChild(node.moduleSpecifier),
