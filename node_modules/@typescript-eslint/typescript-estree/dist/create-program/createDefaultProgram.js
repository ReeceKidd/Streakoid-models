...
function createDefaultProgram(code, extra) {
    ...
    const commandLine = ts.getParsedCommandLineOfConfigFile(
        tsconfigPath,
        shared_1.createDefaultCompilerOptionsFromExtra(extra),
        Object.assign(Object.assign({}, ts.sys), { onUnRecoverableConfigFileDiagnostic: () => {} }),
    );
    if (!commandLine) {
        return undefined;
    }
    ...
    compilerHost.readFile = fileName =>
        path_1.default.normalize(fileName) === path_1.default.normalize(extra.filePath) ? code : oldReadFile(fileName);
