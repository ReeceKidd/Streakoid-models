...
const SCHEMA = {
    ...
    items: {
        oneOf: [
            ...
            ...selectorSchema('property', true, ['private', 'protected', 'public', 'static', 'readonly', 'abstract']),
            ...selectorSchema('parameterProperty', true, ['private', 'protected', 'public', 'readonly']),
            ...selectorSchema('method', false, ['private', 'protected', 'public', 'static', 'abstract']),
            ...selectorSchema('accessor', true, ['private', 'protected', 'public', 'static', 'abstract']),
...
exports.default = util.createRule({
    ...
    create(contextWithoutDefaults) {
        ...
        function getMemberModifiers(node) {
            ...
            if (
                node.type === experimental_utils_1.AST_NODE_TYPES.TSAbstractClassProperty ||
...
function createValidator(type, context, allConfigs) {
    ...
    const configs = allConfigs
        ...
        .filter(c => (c.selector & selectorType) !== 0 || c.selector === MetaSelectors.default)
        .sort((a, b) => {
        ...
        */
            const aSelector = isMetaSelector(a.selector) ? a.selector : a.selector << SELECTOR_COUNT;
            const bSelector = isMetaSelector(b.selector) ? b.selector : b.selector << SELECTOR_COUNT;
    ...
    return (node, modifiers = new Set()) => {
        ...
        for (const config of configs) {
            if (
                ((_a = config.filter) === null || _a === void 0 ? void 0 : _a.regex.test(originalName)) !==
    ...
    function formatReportData({ affixes, formats, originalName, position, custom }) {
        ...
        return {
            ...
            formats:
                formats === null || formats === void 0 ? void 0 : formats.map(f => PredefinedFormats[f]).join(', '),
            regex:
                (_a = custom === null || custom === void 0 ? void 0 : custom.regex) === null || _a === void 0
                    ? void 0
                    : _a.toString(),
            regexMatch:
    ...
    function validateUnderscore(position, config, name, node, originalName) {
        ...
        const trimUnderscore = position === 'leading' ? () => name.slice(1) : () => name.slice(0, -1);
        switch (option) {
    ...
    function validateAffix(position, config, name, node, originalName) {
        ...
        for (const affix of affixes) {
            ...
            const trimAffix =
                position === 'prefix' ? () => name.slice(affix.length) : () => name.slice(0, -affix.length);
            if (hasAffix) {
...
function normalizeOption(option) {
    ...
    (_b = option.types) === null || _b === void 0
        ? void 0
        : _b.forEach(mod => {
    ...
    return {
        ...
        trailingUnderscore:
            option.trailingUnderscore !== undefined ? UnderscoreOptions[option.trailingUnderscore] : null,
        ...
        modifiers:
            (_d = (_c = option.modifiers) === null || _c === void 0 ? void 0 : _c.map(m => Modifiers[m])) !== null &&
            _d !== void 0
                ? _d
                : null,
        types:
            (_f = (_e = option.types) === null || _e === void 0 ? void 0 : _e.map(m => TypeModifiers[m])) !== null &&
            _f !== void 0
                ? _f
                : null,
        filter:
