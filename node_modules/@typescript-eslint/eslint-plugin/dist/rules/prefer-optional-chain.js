            ...
            [[
                ...
                if (expressionCount > 1) {
                    if (previous.right.type === experimental_utils_1.AST_NODE_TYPES.BinaryExpression) {
                        ...
                        optionallyChainedCode += ` ${previous.right.operator} ${sourceCode.getText(
        ...
        function getText(node) {
            ...
            if (
                ...
                const openingParenToken = util.nullThrows(
                    sourceCode.getFirstTokenBetween(node.callee, closingParenToken, util.isOpeningParenToken),
...
const ALLOWED_NON_COMPUTED_PROP_TYPES = new Set([experimental_utils_1.AST_NODE_TYPES.Identifier]);
