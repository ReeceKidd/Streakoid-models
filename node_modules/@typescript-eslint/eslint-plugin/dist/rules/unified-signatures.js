...
exports.default = util.createRule({
    ...
    create(context) {
        ...
        function failureStringStart(otherLine) {
            ...
            const overloads =
                otherLine === undefined ? 'These overloads' : `This overload and the one on line ${otherLine}`;
                ...
                switch (unify.kind) {
                    ...
                    case 'extra-parameter': {
                        ...
                        context.report({
                            ...
                            messageId:
                                extraParameter.type === experimental_utils_1.AST_NODE_TYPES.RestElement
        ...
        function signatureUsesTypeParameter(sig, isTypeParameter) {
            return sig.params.some(p =>
                typeContainsTypeParameter(isTSParameterProperty(p) ? p.parameter.typeAnnotation : p.typeAnnotation),
            );
        ...
        function typesAreEqual(a, b) {
            return (
                ...
                (a !== undefined &&
                    b !== undefined &&
                    sourceCode.getText(a.typeAnnotation) === sourceCode.getText(b.typeAnnotation))
            );
        }
        ...
        return {
            ...
            TSDeclareFunction(node) {
                ...
                addOverload(
                    node,
                    (_b = (_a = node.id) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0
                        ? _b
