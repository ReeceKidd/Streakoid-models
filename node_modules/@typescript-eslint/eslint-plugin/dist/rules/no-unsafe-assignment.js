    ...
    create(context) {
        ...
        function checkObjectDestructure(receiverNode, senderType, senderNode) {
            const properties = new Map(
                senderType
                    .getProperties()
                    .map(property => [property.getName(), checker.getTypeOfSymbolAtLocation(property, senderNode)]),
            );
            let didReport = false;
            for (let receiverIndex = 0; receiverIndex < receiverNode.properties.length; receiverIndex += 1) {
                ...
                if (receiverProperty.computed === false) {
                    ...
                    receiverProperty.key.type === experimental_utils_1.AST_NODE_TYPES.TemplateLiteral &&
        ...
        function checkAssignment(receiverNode, senderNode, reportingNode, comparisonType) {
            ...
            const receiverType =
                comparisonType === 2 /* Contextual */
                    ? (_a = util.getContextualType(checker, receiverTsNode)) !== null && _a !== void 0
                        ? _a
        ...
        return {
            ...
            'JSXAttribute[value != null]'(node) {
                ...
                if (
                    value.type !== experimental_utils_1.AST_NODE_TYPES.JSXExpressionContainer ||
