    ...
    create(context, [options]) {
        ...
        return {
            TSArrayType(node) {
                ...
                const messageId = defaultOption === 'generic' ? 'errorStringGeneric' : 'errorStringGenericSimple';
                ...
                context.report({
                    ...
                    fix(fixer) {
                        const toFix = [fixer.replaceTextRange([node.range[1] - 2, node.range[1]], '>')];
            ...
            TSTypeReference(node) {
                ...
                const messageId = defaultOption === 'array' ? 'errorStringArray' : 'errorStringArraySimple';
