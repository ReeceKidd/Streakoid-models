    ...
    create(context) {
        ...
        function checkDefaultParamLast(node) {
            ...
            for (let i = node.params.length - 1; i >= 0; i--) {
                ...
                const param =
                    current.type === experimental_utils_1.AST_NODE_TYPES.TSParameterProperty
                        ? current.parameter
                        : current;
                ...
                if (
                    hasSeenPlainParam &&
                    (isOptionalParam(param) || param.type === experimental_utils_1.AST_NODE_TYPES.AssignmentPattern)
                ) {
