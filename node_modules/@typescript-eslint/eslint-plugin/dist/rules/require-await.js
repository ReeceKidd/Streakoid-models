...
exports.default = util.createRule({
    ...
    create(context) {
        ...
        function markAsHasDelegateGen(node) {
            ...
            if (
                ((_a = node === null || node === void 0 ? void 0 : node.argument) === null || _a === void 0
                    ? void 0
...
function isEmptyFunction(node) {
    var _a;
    return (
        ((_a = node.body) === null || _a === void 0 ? void 0 : _a.type) ===
            experimental_utils_1.AST_NODE_TYPES.BlockStatement && node.body.body.length === 0
    );
}
