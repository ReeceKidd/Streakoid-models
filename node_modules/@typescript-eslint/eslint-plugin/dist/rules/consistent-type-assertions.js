...
exports.default = util.createRule({
    ...
    create(context, [options]) {
        ...
        function isConst(node) {
            ...
            return (
                node.typeName.type === experimental_utils_1.AST_NODE_TYPES.Identifier && node.typeName.name === 'const'
            );
        }
        function reportIncorrectAssertionType(node) {
            ...
            context.report({
                node,
                messageId,
                data: messageId !== 'never' ? { cast: sourceCode.getText(node.typeAnnotation) } : {},
            });
        }
