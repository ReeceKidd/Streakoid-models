...
exports.default = util.createRule({
    ...
    create(context, [{ ignoreRestArgs, fixToUnknown }]) {
        ...
        function isNodeValidArrayTSTypeReference(node) {
            return (
                node.type === experimental_utils_1.AST_NODE_TYPES.TSTypeReference &&
        ...
        function isGreatGrandparentRestElement(node) {
            ...
            return (
                ((_b =
                    (_a = node === null || node === void 0 ? void 0 : node.parent) === null || _a === void 0
                        ? void 0
                        : _a.parent) === null || _b === void 0
                    ? void 0
                    : _b.parent) != null && isNodeRestElementInFunction(node.parent.parent.parent)
            );
        }
        /**
