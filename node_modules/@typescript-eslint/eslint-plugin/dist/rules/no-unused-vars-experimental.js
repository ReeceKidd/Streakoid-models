    ...
    create(context, [userOptions]) {
        ...
        const options = {
            ignoredNames:
                userOptions && typeof userOptions.ignoredNamesRegex === 'string'
                    ...
                    : null,
            ignoreArgsIfArgsAfterAreUsed:
                (_a = userOptions.ignoreArgsIfArgsAfterAreUsed) !== null && _a !== void 0 ? _a : false,
        };
        ...
        function handleParameterDeclaration(identifier, parent) {
            ...
            */
            ...
            const isLastParameter = parent.parent.parameters.indexOf(parent) === parent.parent.parameters.length - 1;
