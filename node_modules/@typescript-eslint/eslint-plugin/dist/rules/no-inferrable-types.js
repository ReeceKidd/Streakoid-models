...
exports.default = util.createRule({
    ...
    create(context, [{ ignoreParameters, ignoreProperties }]) {
        function isFunctionCall(init, callName) {
            return (
                (init.type === experimental_utils_1.AST_NODE_TYPES.CallExpression ||
        ...
        function hasUnaryPrefix(init, ...operators) {
            return (
                init.type === experimental_utils_1.AST_NODE_TYPES.UnaryExpression && operators.includes(init.operator)
            );
        }
        const keywordMap = {
        ...
        function isInferrable(annotation, init) {
            switch (annotation.type) {
                ...
                case experimental_utils_1.AST_NODE_TYPES.TSTypeReference: {
                    if (
                        annotation.typeName.type === experimental_utils_1.AST_NODE_TYPES.Identifier &&
                        annotation.typeName.name === 'RegExp'
                    ) {
                        const isRegExpLiteral =
                            init.type === experimental_utils_1.AST_NODE_TYPES.Literal && init.value instanceof RegExp;
        ...
        function reportInferrableType(node, typeNode, initNode) {
            ...
            const type =
                typeNode.typeAnnotation.type === experimental_utils_1.AST_NODE_TYPES.TSTypeReference
