...
function getRank(node, orderConfig, supportsModifiers) {
    ...
    const accessibility = 'accessibility' in node && node.accessibility ? node.accessibility : 'public';
        ...
        return {
            ClassDeclaration(node) {
                ...
                validateMembersOrder(
                    node.body.body,
                    (_a = options.classes) !== null && _a !== void 0 ? _a : options.default,
                    true,
                );
            },
            ClassExpression(node) {
                ...
                validateMembersOrder(
                    node.body.body,
                    (_a = options.classExpressions) !== null && _a !== void 0 ? _a : options.default,
                    true,
                );
            },
            TSInterfaceDeclaration(node) {
                ...
                validateMembersOrder(
                    node.body.body,
                    (_a = options.interfaces) !== null && _a !== void 0 ? _a : options.default,
                    false,
                );
            },
            TSTypeLiteral(node) {
                ...
                validateMembersOrder(
                    node.members,
                    (_a = options.typeLiterals) !== null && _a !== void 0 ? _a : options.default,
                    false,
                );
            },
        };
