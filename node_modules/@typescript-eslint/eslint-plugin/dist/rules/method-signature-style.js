    ...
    create(context, [mode]) {
        ...
        function getMethodParams(node) {
            ...
            if (node.params.length > 0) {
                ...
                const closingParen = util.nullThrows(
                    sourceCode.getTokenAfter(node.params[node.params.length - 1], util.isClosingParenToken),
        ...
        return {
            ...
            TSPropertySignature(propertyNode) {
                var _a;
                const typeNode =
                    (_a = propertyNode.typeAnnotation) === null || _a === void 0 ? void 0 : _a.typeAnnotation;
                if (
                    (typeNode === null || typeNode === void 0 ? void 0 : typeNode.type) !==
