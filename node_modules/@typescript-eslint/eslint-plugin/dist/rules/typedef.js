...
exports.default = util.createRule({
    ...
    create(context, [options]) {
        ...
        function isVariableDeclarationIgnoreFunction(node) {
            return (
                !!options['variableDeclarationIgnoreFunction' /* VariableDeclarationIgnoreFunction */] &&
        ...
        return {
            ...
            ClassProperty(node) {
                ...
                if (options['memberVariableDeclaration' /* MemberVariableDeclaration */] && !node.typeAnnotation) {
                    report(
                        node,
                        node.key.type === experimental_utils_1.AST_NODE_TYPES.Identifier ? node.key.name : undefined,
                    );
                }
            },
            ...
            'TSIndexSignature, TSPropertySignature'(node) {
                if (options['propertyDeclaration' /* PropertyDeclaration */] && !node.typeAnnotation) {
                    report(
                        node,
                        node.type === experimental_utils_1.AST_NODE_TYPES.TSPropertySignature
            ...
            VariableDeclarator(node) {
                if (
                    !options['variableDeclaration' /* VariableDeclaration */] ||
