...
exports.default = util.createRule({
    ...
    create(context, [options]) {
        ...
        function isUnexported(node) {
            ...
            while (node) {
                if (
                    node.type === experimental_utils_1.AST_NODE_TYPES.ExportDefaultDeclaration ||
        ...
        function isAllowedName(node) {
            ...
            if (node.type === experimental_utils_1.AST_NODE_TYPES.VariableDeclarator) {
                ...
                if (
                    node.key.type === experimental_utils_1.AST_NODE_TYPES.TemplateLiteral &&
        ...
        function findFunctionExpressionsInScope(variable) {
            const writeExprs = variable.references
                ...
                .filter(
                    expr =>
                        (expr === null || expr === void 0 ? void 0 : expr.type) ===
        ...
        function findFunctionInScope(variable) {
            ...
            if (
                (functionNode === null || functionNode === void 0 ? void 0 : functionNode.type) !==
        ...
        function checkWithTrackingReferences(node) {
            ...
            if (variable.defs[0].type === 'ClassName') {
                ...
                for (const classElement of classNode.body.body) {
                    if (
                        classElement.type === experimental_utils_1.AST_NODE_TYPES.MethodDefinition &&
                        classElement.value.type === experimental_utils_1.AST_NODE_TYPES.FunctionExpression
                    ) {
                        checkFunctionExpression(classElement.value);
                    }
                    if (
                        classElement.type === experimental_utils_1.AST_NODE_TYPES.ClassProperty &&
                        (((_a = classElement.value) === null || _a === void 0 ? void 0 : _a.type) ===
                            experimental_utils_1.AST_NODE_TYPES.FunctionExpression ||
