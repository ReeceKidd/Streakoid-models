...
declare function isOptionalChainPunctuator(
...
declare function isNonNullAssertionPunctuator(
    token: TSESTree.Token | TSESTree.Comment,
): token is TSESTree.PunctuatorToken & {
    value: '!';
};
 ...
 */
declare function isOptionalOptionalCallExpression(
    node: TSESTree.Node,
 ...
 */
declare function isLogicalOrOperator(
    node: TSESTree.Node,
 ...
 * ```
 */
declare function isTypeAssertion(
...
declare function isFunctionType(
    node: TSESTree.Node | undefined,
): node is
...
declare function isFunctionOrFunctionType(
    node: TSESTree.Node | undefined,
): node is
...
declare function isClassOrTypeElement(
    node: TSESTree.Node | undefined,
 ...
 */
declare function isAwaitKeyword(
    node: TSESTree.Token | TSESTree.Comment | undefined | null,
): node is TSESTree.KeywordToken & {
    value: 'await';
};
declare function isMemberOrOptionalMemberExpression(
    node: TSESTree.Node,
