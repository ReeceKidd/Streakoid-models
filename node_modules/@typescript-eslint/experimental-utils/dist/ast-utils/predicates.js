...
function isOptionalOptionalCallExpression(node) {
    return (
        node.type === ts_estree_1.AST_NODE_TYPES.OptionalCallExpression &&
...
function isTypeAssertion(node) {
    ...
    return (
        node.type === ts_estree_1.AST_NODE_TYPES.TSAsExpression ||
...
function isConstructor(node) {
    return (
        (node === null || node === void 0 ? void 0 : node.type) === ts_estree_1.AST_NODE_TYPES.MethodDefinition &&
...
function isAwaitKeyword(node) {
    return (
        (node === null || node === void 0 ? void 0 : node.type) === ts_estree_1.AST_TOKEN_TYPES.Identifier &&
        node.value === 'await'
    );
}
...
function isMemberOrOptionalMemberExpression(node) {
    return (
        node.type === ts_estree_1.AST_NODE_TYPES.MemberExpression ||
